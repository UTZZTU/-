...
int N = 100;//资源的最大数
int M = 100;//进程的最大数
int Need[MAX][MAX]={0};//还需要资源矩阵
int Available[MAX]={0};//可用资源矩阵
int Work[MAX]={0};//存放系统可提供资源量 
int Finish[MAX]={0}; //标记系统是否有足够的资源分配给各个进程 
int Security[MAX]={0};//存放安全序列
char NAME[MAX]={0};//资源的名称
int Request[MAX]={0};//请求资源向量	
int Max[MAX][MAX]={0};//最大需求矩阵
int Allocation[MAX][MAX]={0};//系统已分配矩阵
